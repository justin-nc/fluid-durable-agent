...
public class Agent_Conversation
{
        ...
        )
    {
        ...
        if (messageEvaluation != null)
        {
            ...
            if (messageEvaluation.ContainsRequest && !messageEvaluation.ContainsIrrelevance){
            ...
            if (messageEvaluation.ContainsIrrelevance)
...
UNIQUE SCENARIOS:
- If a users asks you to show them a certain field, Your response should be To see the **[field label]** field, simply click this chat bubble.
...
EXAMPLE 9 - User asking for a certain field, saying ""where is the title?""
{{
  ""FinalThoughts"": ""To see the **Project Title** field, simply click this chat bubble.""
}}
